...
add({id:'privacy',label:'Privacy',title:'Test preview.\nNot a live enquiry service.',kind:'information',body:'This identity version does not send enquiries or store them on a server. Use fictional details in the enquiry preview. The optional film player contacts YouTube only when you choose to watch. The separately linked Make it land game has optional gameplay analytics and its own newsletter and data-choice controls. Production privacy, retention and consent wording remains subject to approval.',details:['No website-page marketing tracking','Separate game data choices','Film loads only on request']});
export {retained};
